...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    visualizarMesBtn = document.getElementById('visualizarMesBtn'); // <<<<<< AQUI ESTÁ O ELEMENTO
    ...
    console.log("visualizarMesBtn:", visualizarMesBtn); // <<<<<< VERIFICAÇÃO AQUI
    ...
    if (visualizarMesBtn) { // <<<<<< VERIFICAÇÃO AQUI
