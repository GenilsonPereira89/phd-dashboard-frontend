...
const limparRelatorioBtn = document.getElementById('limparRelatorioBtn'); // NOVO SELETOR PARA O BOTÃO LIMPAR
...
// MODIFICADO: Buscar produções por período (agora sem alert em caso de erro de fetch)
...
// MODIFICADO: Popula os seletores de mês e ANO para o relatório comparativo
...
// MODIFICADO: Gerar Relatório Comparativo (agora usa o ano do seletor do relatório e gerencia visibilidade dos botões)
...
// NOVO EVENT LISTENER: Botão Limpar Relatório
