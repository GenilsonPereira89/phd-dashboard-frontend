...
async function atualizarDashboard(ano, mes) {
    ...
    const tempDateForRemainingQuinzenaDays = new Date(dataAtualCalculo.getTime()); // CORREÇÃO AQUI: Remove o "+ 1"
    ...
    const tempDateForRemainingDays = new Date(dataAtualCalculo.getTime()); // CORREÇÃO AQUI: Remove o "+ 1"
